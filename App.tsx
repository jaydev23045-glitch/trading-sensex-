      ...
      <main className="max-w-[1600px] mx-auto p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
           <div className="bg-[#0f172a] rounded-xl border border-slate-800 p-6 flex flex-col gap-6 relative overflow-hidden">
              ...
              <button onClick={() => handleBuy('CE')} className="w-full py-4 font-black uppercase tracking-widest rounded-lg shadow-lg transition-all flex items-center justify-center gap-2 bg-emerald-600 hover:bg-emerald-500 text-white shadow-emerald-500/20 active:scale-95">
           ...
           <div className="bg-[#0f172a] rounded-xl border border-slate-800 p-6 flex flex-col gap-6 relative overflow-hidden">
              ...
              <button onClick={() => handleBuy('PE')} className="w-full py-4 font-black uppercase tracking-widest rounded-lg shadow-lg transition-all flex items-center justify-center gap-2 bg-rose-600 hover:bg-rose-500 text-white shadow-rose-500/20 active:scale-95">
